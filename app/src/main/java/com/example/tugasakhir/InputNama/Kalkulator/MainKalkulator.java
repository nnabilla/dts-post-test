package com.example.tugasakhir.InputNama.Kalkulator;
        ...
        tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if((angka_pertama.getText().length()>0) && (angka_kedua.getText().length()>0))
                {
                    ...
                    Toast toast = Toast.makeText(MainKalkulator.this,
        ...
        kurang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if((angka_pertama.getText().length()>0) && (angka_kedua.getText().length()>0))
                {
                    ...
                    Toast toast = Toast.makeText(MainKalkulator.this, "Mohon masukkan Angka pertama & Kedua", Toast.LENGTH_LONG);
                    toast.show();
                }
            }
        });
