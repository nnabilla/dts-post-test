/*
package com.example.tugasakhir.SQLite;
...
import com.example.tugasakhir.SQLite.helper.DbHelper;
...
public class AddEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        id = getIntent().getStringExtra(MainSQLite.TAG_ID);
        name = getIntent().getStringExtra(MainSQLite.TAG_NAME);
        address = getIntent().getStringExtra(MainSQLite.TAG_ADDRESS);
